...
fn handle_collisions<T: Component>(
    mut collison_event_writer: EventWriter<CollisionEvent>,
    ...
    for (entity, collider) in query.iter() {
        for &collided_entity in collider.colliding_entities.iter() {
            ...
            collison_event_writer.send(CollisionEvent::new(entity, collided_entity));
        }
    }
}

pub fn apply_collison_damage(
